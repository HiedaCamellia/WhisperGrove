...
public class FeatureEntry<F extends FeatureConfiguration> {
    ...
    private DeferredHolder<Feature<?>,? extends Feature<?>> featureObject;
    ...
    public FeatureEntry<F> id(String id) {
        this.id = id;
        this.placedKey = ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath(modId, id));
        this.configKey = ResourceKey.create(Registries.CONFIGURED_FEATURE, ResourceLocation.fromNamespaceAndPath(modId, id));
        return this;
    }
    ...
    @SuppressWarnings("unchecked")
    public static <FC extends FeatureConfiguration, F extends Feature<FC>> void configBootStrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
