...
public record Viscera(ResourceLocation name, Double yin, Double yang, Double ping) {
    ...
    public static final Codec<Viscera> CODEC = RecordCodecBuilder.create(instance -> instance.group(
                    ...
                    Codec.DOUBLE.fieldOf("ping").forGetter(Viscera::ping))
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, Viscera> STREAM_CODEC = StreamCodec.composite(
            ...
            ByteBufCodecs.DOUBLE, Viscera::yang,
            ByteBufCodecs.DOUBLE, Viscera::ping, Viscera::new);
