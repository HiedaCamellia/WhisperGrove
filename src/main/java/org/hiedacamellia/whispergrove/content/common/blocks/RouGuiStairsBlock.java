...
public class RouGuiStairsBlock extends StairBlock {
    private final String regname;

    public RouGuiStairsBlock(String regname) {
        super(WGBlock.RouGuiPlanks.get().defaultBlockState() ,Properties.of().mapColor(MapColor.WOOD).sound(SoundType.WOOD));
